...
T.KnownSpells = {
	...
	[89]={type="aura", target=1, duration=3, damageATK=40},
	...
	[54]={
		...
		{type="nuke", target=1, damageATK=45}
	},
	...
	[164]={type="nuke", target="cone", damageATK=200, echo=3},
	...
	[107]={
		{type="aura", target="all-enemies", damageATK=40, duration=4},
	...
	[187]={type="nuke", target="all-enemies", echo=2, damageATK=50},
	...
	[252]={
		{type="nuke", target="cleave", damageATK=60, },
		{type="aura", target="cleave", duration=2, modDamageTaken=25, },
	},
	[253]={type="nuke", target="enemy-front", damageATK=75, },
	[254]={type="aura", target="all-other-allies", firstTurn=3, duration=3, thornsATK=100, },
	[125]={
		{type="fork", target="all-enemies"},
		{type="nuke", target="fork", damageATK=60, },
	},
	[219]={
	...
	[195]={type="aura", target="cone", duration=3, damageATK=80, },
	[207]={type="nuke", target=0, damageATK=30},
	[212]={
		{type="fork", target="all"},
		{type="nuke", target="fork", damageATK=200, },
	},
	...
	[232]={
		{type="fork", target="all-enemies"},
		{type="aura", target="fork", duration=3, modDamageDealt=-50, },
	},
