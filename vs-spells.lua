...
T.KnownSpells = {
	...
	[91]={type="aura", target=1, duration=3, plusDamageDealtATK=-60, desc="Reduces the damage dealt by the furthest enemy by 1 for 3 rounds."},
	...
	[85]={type="aura", target=3, duration=2, firstTurn=3, modDamageTaken=-5000, desc="Reduces the damage taken by the closest ally by 5000% for two rounds."},
